...
function App() {
  // Comprobación de página oculta por parámetro de URL (?page=video) o Hash (#video)
  const isVideoPage =
    window.location.pathname === '/video-editor' ||
    window.location.pathname.startsWith('/video-editor') ||
    window.location.search.includes('page=video') ||
